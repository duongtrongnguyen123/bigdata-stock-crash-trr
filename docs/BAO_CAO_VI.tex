...
Nhóm gồm hai thành viên; khối lượng công việc được phân chia theo tỉ lệ khoảng \textbf{60/40} dựa trên vai trò và đóng góp thực tế:

\begin{table}[H]
    \centering
    \renewcommand{\arraystretch}{1.3}
    \begin{tabularx}{\textwidth}{@{} >{\raggedright\arraybackslash}p{3.5cm} c X @{}}
    \toprule
    \textbf{Thành viên} & \textbf{Tỉ lệ} & \textbf{Công việc đảm nhận} \\
    \midrule
    \textbf{Dương Trọng Nguyên} & \textbf{60\%} &
    ...
    \end{itemize} \\
    \midrule
    \textbf{Nguyễn Ngọc Bình An} & \textbf{40\%} &
    \begin{itemize}[leftmargin=1.2em, nosep]
